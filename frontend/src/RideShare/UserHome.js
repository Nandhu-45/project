...
function UserHome(){
    ...
    function msgToAdmin(){
        ...
        // axios.get("http://localhost:8888/AddusermessagesContent?id="+que+"&msg="+msg+"&msgDate="+today+"&userEmail="+localStorage.getItem("userEmail")+"&userName="+localStorage.getItem("userName")).then((res)=>{
                    ...
                    <a class="navbar-brand" href="#"/>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                            <div class="offcanvas-header">
                                <h5 class="offcanvas-title" id="offcanvasRightLabel">Message To Admin</h5>
