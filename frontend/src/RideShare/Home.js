...
function Home(){
    ...
    return(
        ...
        <div>
            ...
            <div class="container">
                <a class="navbar-brand" href="#"><img className="logo" src="https://www.muni.org/Departments/transit/ShareARide/PublishingImages/RideShareLogo.png" /></a>
                ...
                {/* <form class="d-flex" role="search">
                    ...
                    <button class="btn btn-outline-success" type="submit" onClick={registerUser}>Search</button>
                </form> */}
                </div>
            </div>
            </nav>
